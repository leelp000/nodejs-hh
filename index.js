...
const SUB_PATH = process.env.SUB_PATH || 'lianj';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '67262e18-b816-4def-ac18-e48503d398b2'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖,67262e18-b816-4def-ac18-e48503d398b2
...
const NAME = process.env.NAME || 'koybe';                        // 节点名称
